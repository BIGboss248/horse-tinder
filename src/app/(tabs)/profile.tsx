...
export default function ProfileScreen() {
  const horseProfile = {
    ...
    images: [
      "https://picsum.photos/id/1015/800/600", // replace with real horse photos
      ...
      <ScrollView className="flex-1">
        ...
        <View className="relative">
          ...
          <View className="absolute top-4 left-4 right-4 flex-row justify-between items-center z-10">
            <TouchableOpacity className="bg-black/40 p-3 rounded-full active:bg-black/60">
          ...
          {/* App Branding */}
          <View className="absolute top-4 left-1/2 -translate-x-1/2 bg-white/95 px-6 py-1.5 rounded-full shadow">
            <Text className="text-[#8B4513] font-bold text-2xl tracking-[2px]">
              UNIWIND 🐎
            </Text>
          </View>
        </View>
        ...
        {/* Main Content Card */}
        <View className="px-6 pt-8 pb-12 bg-white dark:bg-[#3A2A1F] rounded-t-3xl -mt-8">
          <View className="flex-row justify-between items-start">
            ...
            <TouchableOpacity className="bg-amber-600 px-7 py-3.5 rounded-2xl active:bg-amber-700">
          ...
          <View className="flex-row gap-3 mt-7">
            ...
            <View className="flex-1 bg-[#F5EDE0] dark:bg-[#4A3728] p-5 rounded-2xl">
              ...
              <Text className="text-base font-medium text-[#2C1F14] dark:text-white mt-1 leading-tight">{horseProfile.location}</Text>
            </View>
          </View>
